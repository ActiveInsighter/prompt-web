...
| `scrollbar-thumb-*` | Sets the [thumb color](https://tailwindcss.com/docs/scrollbar-color) of an element's scrollbar |
| `scrollbar-track-*` | Sets the [track color](https://tailwindcss.com/docs/scrollbar-color) of an element's scrollbar |
